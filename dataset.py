...
class KittiSeq(Dataset):
    def __init__(self,root, sample_list, input_size, seq_len=3,
    ...
    def __getitem__(self, index):
        ...
        # default collect_fn_ in dataloader do not allow None type value
        inputs={}     
        # fetch current frame and last seq_len-1 frames
        ...
        if self.with_depth:
            inputs['depth_gt']=[self.get_depth(folder,frame_id+i,side) for i in range(self.seq_len)]
